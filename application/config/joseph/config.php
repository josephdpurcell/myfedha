...
|
*/
$config['base_url']	= 'http://j.myfedha.com';
...
|
*/
$config['encryption_key'] = 'giojibvitbuxAnEcCysAkHodyerIgCeubtethviDu1Cichyumgeup_obTherwac;';
...
|--------------------------------------------------------------------------
|
| Use this salt to add before hashing data to add extra security.
|
*/
$config['salt'] = 'waljenotonRilAtAfwycsOwWogHunArdudLushdalvochlirrOgshElIthVifsOrsIpGegbooftup1freGhedyoavyachlaydsudpesShytejEgOickudGut-Shlikda';
...
set_include_path('.'
    . PATH_SEPARATOR . APP_ROOT . '/application/libraries'
